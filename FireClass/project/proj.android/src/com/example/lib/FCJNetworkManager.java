...
public class FCJNetworkManager {
	
	private WifiManager mWifiManager;
	private WifiInfo mWifiInfo;
	private DhcpInfo dhcpInfo;
	
	private String TAG = "FCJNetworkManager";
	// 扫描出的网络连接列表
...
//	private String mSSID = "";
	...
	private static FCJNetworkManager s_sharedNetwork = null;

	private FCJNetworkManager(){}
	
	public static  FCJNetworkManager getInstance(){
		if (s_sharedNetwork == null)
		{
			s_sharedNetwork = new FCJNetworkManager();
			s_sharedNetwork.init();
		}
	...
	public void addNetwork(WifiConfiguration wcg) {
		...
		FCJWifiHotPot.closeWifiAp(mContext);
...
//		mTimer.schedule(mTimerTask, 0, 20 * 1000);// 20s
	...
	public String getIPAddress() {
		return (String) ((mWifiInfo == null) ? 0 : FormatIP(mWifiInfo.getIpAddress()));
	}
	...
	public String getGateWay(){
		...
		return (mWifiInfo == null) ? "" : FormatIP(dhcpInfo.gateway);
	}
